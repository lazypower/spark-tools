...
A Go monorepo providing three tools for local LLM workflows on DGX Spark hardware:
...
- **Dependency order:** hfetch has no internal deps. llm-run depends on hfetch. llm-bench depends on both.
