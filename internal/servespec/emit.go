// Package servespec renders a validated launch contract into a host-appropriate
...
func planLaunch(r *servecontract.Resolved, h Host) (flags []string, warnings []string) {
...
func SpecHash(r *servecontract.Resolved, h Host) string {
...
func Render(target Target, r *servecontract.Resolved, h Host) (string, error) {
	switch target {
	case TargetCompose:
